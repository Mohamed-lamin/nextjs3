...
function Vochome({ pages }) {
  ...
  return (
    <>
      <Head>
        <title> تعلم النطق باللغة الإنجليزية-English Vocabulary</title>
        <meta
          name="description"
          content="النطق باللغة الإنجليزية, كلمات مفيدة تحتاجها عند السفر او للعمل, التمرّن على النطق باللغة الإنجليزية بالغ الأهمية و هذه قائمة طويلة من مجموعة كلمات ستفيدك في إثراء رصيدك المعرفي في مجال تعلّم اللغة الإنجليزية"
        />
        <meta
          property="og:title"
          content="كلمات مفيدة باللغة الإنجليزية و كيفية نطقها"
        />
        <meta
          property="og:image"
          content="../../public/images/pronounciation.png"
        />
      </Head>
