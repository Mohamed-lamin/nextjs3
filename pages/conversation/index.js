...
function Vochome({ posts }) {
  ...
  return (
    <>
      <Head>
        <title>المحادثات باللغة الإنجليزية- English Conversations</title>
        <meta
          name="description"
          content="تعلم المحادثة باللغة الإنجليزية, محادثات شيّقة ستذهب بك بعيدا في مجال اللغة الإنجليزية, محدثات في أمكان متعددة و غنية جدا بالمفردات القيّمة"
        />
        <meta property="og:title" content="تعلّم المحادثة باللغة الإنجليزية" />
        <meta
          property="og:image"
          content="../../public/images/explanation.png"
        />
      </Head>
